...
import { MapPin, Clock, Flame, Plus, Footprints, ChevronRight } from 'lucide-react';
...
const Home = () => {
  ...
  return (
    <div className="p-6 pb-24 min-h-screen">
      ...
      {/* --- SECTION 1: MY HEALTH (Clickable -> Dashboard) --- */}
      <div className="mb-8">
        <h3 className="text-xl font-semibold mb-3 text-white">My Health</h3>
        
        <Link to="/dashboard">
            <div className="bg-white/10 backdrop-blur-md rounded-3xl p-4 border border-white/5 flex justify-between items-center hover:bg-white/20 transition cursor-pointer">
                {/* Stats Group */}
      ...
      {/* --- SECTION 3: PREVIOUS TASKS (Clickable -> History) --- */}
      <div>
         <h3 className="text-xl font-semibold mb-3 text-white">Previous Tasks</h3>
         
         <Link to="/history">
             <div className="bg-white/10 backdrop-blur-md rounded-3xl p-5 border border-white/5 flex items-center justify-between hover:bg-white/20 transition cursor-pointer">
